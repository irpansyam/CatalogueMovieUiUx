...
public class NowPlayingFragment extends Fragment implements LoaderManager.LoaderCallbacks <ArrayList<MovieItems>>{
    ...
    static final String EXTRAS_MOVIE_NOW_PLAYING = "EXTRAS_MOVIE";
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        progressBar = view.findViewById(R.id.pro_bar_now_playing);
        progressBar.setVisibility(View.VISIBLE);

        list= new ArrayList<>();
        list.addAll(0, Collections.<MovieItems>emptyList());
        rvCategory = view.findViewById(R.id.rv_now_playing);
        ...
        String nowPlaying = "https://api.themoviedb.org/3/movie/now_playing?api_key="+API_KEY+"&language=en-US";
        Bundle bundle = new Bundle();
        bundle.putString(EXTRAS_MOVIE_NOW_PLAYING, nowPlaying);
        LoaderManager loaderManager = getActivity().getLoaderManager();
        if (loaderManager == null){
            loaderManager.initLoader(0, bundle, NowPlayingFragment.this);
        }else {
            loaderManager.restartLoader(0, bundle, NowPlayingFragment.this);
        }
        return view;
    ...
    public Loader<ArrayList<MovieItems>> onCreateLoader(int id, Bundle args) {
        String judulFilm ="";
        if (args != null){
            judulFilm = args.getString(EXTRAS_MOVIE_NOW_PLAYING);
        }
