...
public class HomeFragment extends Fragment implements LoaderManager.LoaderCallbacks <ArrayList<MovieItems>>{
    ...
    static final String EXTRAS_MOVIE_HOME = "EXTRAS_MOVIE";
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        progressBar = view.findViewById(R.id.pro_bar_home);
        ...
        String home = "https://api.themoviedb.org/3/movie/popular?api_key="+API_KEY+"&language=en-US&page=1";
        Bundle bundle = new Bundle();
        bundle.putString(EXTRAS_MOVIE_HOME, home);
        LoaderManager loaderManager = getActivity().getLoaderManager();
        if (loaderManager == null){
            loaderManager.initLoader(0, bundle, HomeFragment.this);
        }else {
            loaderManager.restartLoader(0, bundle, HomeFragment.this);
        }
        return view;
    }
    ...
    public Loader<ArrayList<MovieItems>> onCreateLoader(int id, Bundle args) {
        String judulFilm ="";
        if (args != null){
            judulFilm = args.getString(EXTRAS_MOVIE_HOME);
        }
